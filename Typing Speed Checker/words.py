...
possible_texts = [
    'This package is unfortunately rather large (~20MB), and will run into scaling issues if more word lists '
    'or (especially) options are added. When that bridge is crossed, word lists should possibly be chosen by '
    'the user instead of simply including all of them; word lists could also be preprocessed on the client '
    'side instead of being included in the package.',
    ...
    'Python is a high-level, interpreted general-purpose programming language. Its design philosophy emphasizes code '
